...
export const studios: Studio[] = [
  {
    ...
    briefDescription: "Il nostro studio di punta.",
    image:
      stu1
  ...
  },
  {
    ...
    image:
      stu2,
    briefDescription: "Garantisce registrazioni di massima qualità.",
...

  {
    ...
    image:
      stu3,
      briefDescription: "Studio ideale per momenti creativi.",
