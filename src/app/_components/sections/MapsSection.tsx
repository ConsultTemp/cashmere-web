...
export default function MapsSection() {
  ...
  return (
    <div className="w-full">
      <h2 className="font-bold text-2xl sm:text-3xl mb-4">Dove siamo</h2>
      ...
      <h4 className="text-lg sm:text-xl font-bold mt-4 mb-2">Via Oreste Salomone, 61, 20138 Milano (MI)</h4>
